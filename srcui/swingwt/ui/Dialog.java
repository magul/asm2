...
public abstract class Dialog {
    ...
    public static void showError(String message, String title) {
        JOptionPane.showMessageDialog(theParent, message, title,
    ...
    public static void showError(String message) {
        JOptionPane.showMessageDialog(theParent, message,
    ...
    public static boolean showYesNo(String message, String title) {
        int answer = JOptionPane.showConfirmDialog(theParent, message, title,
