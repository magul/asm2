...
public class FilePreviewPane extends UI.Panel implements PropertyChangeListener,
    ...
    private void updateImage() {
        ...
        try {
            // Load the image icon
            ImageIcon imic = new swingwtx.swing.ImageIcon(chooser.getSelectedFile()
                                                                 .getAbsolutePath());
            ...
            // Set the image info
            lblImageInfo.setText(im.getWidth() + "x" + im.getHeight());
    ...
    public void actionPerformed(swingwt.awt.event.ActionEvent actionEvent) {
    }
}
