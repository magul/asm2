...
import swingwtx.swing.JDesktopPane;
...
import swingwtx.swing.JPasswordField;
...
import swingwtx.swing.JSpinner;
...
public final class UI {
    ...
    public static Label getURLLabel(String text, String tooltiptext,
        ...
        if (onClick != null) {
            l.addMouseListener(new MouseAdapter() {
                    public void mouseClicked(swingwt.awt.event.MouseEvent evt) {
                        onClick.call();
                    }
                });
        }
    ...
    public static void setFocusManager(FlexibleFocusManager f) {
        swingwtx.swing.FocusManager.setCurrentManager(f);
    }
    ...
    public static Component addComponent(Container container, Component c) {
        // Put textareas in a scrollpane and turn off horizontal
        // scrolling
    ...
    public static boolean isCarbon() {
        return SwingWTUtils.isMacOSX();
    }

    public static void initialiseCarbon(Runnable run) {
        SwingWTUtils.initialiseMacOSX(run);
    }

    public static boolean isWindows() {
        return SwingWTUtils.isWindows();
    }
    ...
    public static swingwt.awt.Dimension getScreenSize() {
        return swingwt.awt.Toolkit.getDefaultToolkit().getScreenSize();
    }
    ...
    public static void centerWindow(Window w) {
        ...
        swingwt.awt.Dimension frameSize = w.getSize();
        swingwt.awt.Dimension screenSize = Toolkit.getDefaultToolkit()
                                                  .getScreenSize();
    ...
    public static Image scaleImage(Image inImage, int width, int height) {
        ...
        Global.logDebug("Original: " + w + "x" + h + ", New: " + width + "x" +
            height, "UI.scaleImage");

        return inImage.getScaledInstance(width, height, Image.SCALE_FAST);
    }
    ...
    public static String getRendererName() {
        return "SwingWT " + swingwtx.swing.SwingWTUtils.getVersion() +
        " http://swingwt.sf.net";
    }

    public static String getRendererVersion() {
        return swingwtx.swing.SwingWTUtils.getVersion();
    }
    ...
    public static void invokeIn(Runnable run, int ms) {
        SwingUtilities.invokeIn(run, ms);
    }
    ...
    public static void saveImageAsJpeg(String file, Image image) {
        try {
            ...
            SwingWTUtils.saveImageToJPG(image, os);
            os.close();
        } catch (Exception e) {
            Global.logException(e, UI.class);
        }
    ...
    public static class HTMLBrowser extends JEditorPane
        ...
        public HTMLBrowser(Label status, FunctionPointer onHyperlinkClick) {
            ...
            editorPaneImpl.addHyperlinkListener(this);
        }
        ...
        public void print() {
            // Call print() via javascript on browser widget
            ((org.eclipse.swt.browser.Browser) getSWTPeer()).execute("print()");
        }
    }
    ...
    public static class Table extends JTable implements MouseListener,
        ...
        public void mouseClicked(MouseEvent evt) {
            ...
            if (evt.getButton() != 1) {
                if (toolbar != null) {
                    UI.toolbarToPopupMenu(toolbar).show(this, 0, 0);
                }
    ...
    public static class ToolBar extends JToolBar {
        ...
        public Component add(JButton b) {
            return super.add(b, !platformToolbar);
        }
    }
    ...
    public static class FlowLayout extends swingwt.awt.FlowLayout {
        public FlowLayout() {
            super();
        }
    ...
    public static class BoxLayout extends swingwtx.swing.BoxLayout {
        public BoxLayout(UI.Panel p, int axis) {
            super(p, axis);
        }
    }

    public static class GridLayout extends swingwt.awt.GridLayout {
        public GridLayout(int rows, int cols, int hgap, int vgap) {
            super(rows, cols, hgap, vgap);
        }
    }

    public static class Dimension extends swingwt.awt.Dimension {
    }
}
