 ...
 *  Change Log:
 *
 *        $Log: BOValidationException.java,v $
...
/**
 * Exception to be thrown by business object subclasses
 * validate events to show failure.
 *
 * @see net.sourceforge.sheltermanager.cursorengine.NormalBO
 *
...
public class BOValidationException extends java.lang.Exception {
    ...
    */
    ...
    /**
     * Constructs an instance of <code>BOValidationException</code> with the specified detail message.
     * @param msg the detail message.
     */
    public BOValidationException(String msg) {
        super(msg);
    }
}
