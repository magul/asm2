...
public class ThrobberSmall extends UI.Panel implements Runnable {
    static ImageIcon[] images = new ImageIcon[13];

    static {
        for (int i = 1; i <= 12; i++)
            images[i] = IconManager.getThrobberSmall(i);
    }
    ...
    public ThrobberSmall() {
        super(true); // No panel border
                     // Set our own border just on the left/right sides
