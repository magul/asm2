...
public class SWTTableLayout implements LayoutManager, java.io.Serializable {
    ...
    public SWTTableLayout() {
        this(1, 0, 4, 4);
    }

    public SWTTableLayout(int rows, int cols) {
        this(rows, cols, 4, 4, true);
    }

    public SWTTableLayout(int rows, int cols, boolean leftToRight) {
        this(rows, cols, 4, 4, leftToRight);
    }

    public SWTTableLayout(int rows, int cols, int hgap, int vgap) {
        ...
        if (leftToRight) {
            ...
            for (int i = 0; i < parent.getComponentCount(); i++) {
                parent.getComponent(i)
                      .setBounds(colPoints[cc], curRowPos,
            ...
            int totRows = parent.getHeight() / (parent.getComponent(0)
            ...
            for (int i = 0; i < parent.getComponentCount(); i++) {
                ...
                // Vert pos
                curRowPos += (parent.getComponent(i).getPreferredSize().height +
                vgap);
