...
public class AccountView extends ASMView {
    ...
    public AccountView() {
        init(Global.i18n("uiaccount", "Accounts"), IconManager.getIcon(IconManager.SCREEN_ACCOUNT), "uiaccount");
        updateList();
    }
    ...
    public void updateList() {
    	...
    	try {
	        ...
	        String[][] datar = new String[accounts.size()][6];
	
	        // Create an array of headers for the table
	        String[] columnheaders = {
	                i18n("Code"), i18n("Type"), i18n("Description"), i18n("Reconciled"), i18n("Balance") 
	        };
