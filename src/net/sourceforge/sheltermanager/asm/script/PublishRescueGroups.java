...
/**
 * This class wraps up the publishrescuegroups command
 * and calls various bits of the system to
 * actually do it.
 *
 * Command: publishrescuegroups
 * Options:
 *              includecase
 *              includereserve
 *              includefosters
 ...
 *  Example call:
 *
 *      asmcmd publishrescuegroups excludeunder=8 generatejavascriptdb
 *            scaleimages=2 "includelocations=Top Block"
 *
 * @author Robin Rawson-Tetley
 * @version 1.0
 */
public class PublishRescueGroups {
    public PublishRescueGroups(String[] args) {
        // Enable logging
