...
/**
 * Generates a report from owner search results.
 *
 */
public class OwnerSearchResults extends Report {
    ...
    public OwnerSearchResults(String[][] searchResults, int max, int lastcol,
        String searchTerm) {
        this.max = max;
    ...
    public void generateReport() {
        ...
        String[] headers = OwnerFindColumns.getColumnLabels();
        tableAddRow();
